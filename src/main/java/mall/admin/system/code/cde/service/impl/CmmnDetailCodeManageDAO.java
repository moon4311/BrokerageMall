...
public class CmmnDetailCodeManageDAO extends AbstractDao {
	...
	public CmmnDetailCodeVO selectCmmnDetailCodeDetail(CmmnDetailCodeVO cmmnDetailCodeVO) throws Exception{
		return (CmmnDetailCodeVO) select("CmmnDetailCodeManage.selectCmmnDetailCodeDetail", cmmnDetailCodeVO);
	}
