package egovframework.com.ccm.ccc.service;
...
public interface CmmnClCodeManageService {
	...
	List<?> selectCmmnClCodeList(CmmnClCodeVO searchVO) throws Exception;
	  ...
	  *  @throws Exception
	  */
	CmmnClCodeVO selectCmmnClCodeDetail(CmmnClCodeVO cmmnClCodeVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void upsertCmmnClCode(CmmnClCodeVO cmmnClCodeVO) throws Exception;
	 ...
	 * @return
	 */
	boolean isViewable(CmmnClCodeVO searchVO);
	 ...
	 * @return
	 */
	boolean isModifiable(CmmnClCodeVO searchVO);
}
